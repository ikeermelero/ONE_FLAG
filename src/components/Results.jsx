...
const Results = ({ scores, players, onQuit }) => {
    ...
    let message = "";
    if (players === 1) {
        message = `Resultado final: Jugador 1 ha conseguido ${p1} puntos.`;
    } else if (p1 > p2) {
        message = `Gana Jugador 1 con ${p1} puntos frente a ${p2}.`;
    } else if (p2 > p1) {
        message = `Gana Jugador 2 con ${p2} puntos frente a ${p1}.`;
    } else {
